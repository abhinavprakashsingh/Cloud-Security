...
public class AlgoFrame extends JFrame
{
    ...
    String  bucketName     = "cloud-security-alg";
	  String  keyName="";
    ...
    public static void main(String[] args)
    {
        ...
        algoFrame1.setTitle("Cloud Security" );
        int x=0,y=0;
    ...
    private void jbInit() throws Exception
    {
        ...
        jtfInputFile.setCaretColor(Color.green);
        ...
        jtfOutputFile.setCaretColor(Color.green);
        ...
        jbProperties.setText("Choose Algorithm");
    ...
    pbPosition.setForeground(Color.green);
